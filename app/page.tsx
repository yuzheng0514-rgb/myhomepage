        ...
        <section id="about" className="about-section">
          ...
          <div className="prose intro">
            <p>
              ...
              Previously, I received my B.S. degree from the <a href="https://math.bnu.edu.cn" target="_blank" rel="noreferrer">School of Mathematical Sciences, Beijing Normal University</a>, in 2025.
            </p>
            <p>
